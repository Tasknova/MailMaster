...
-- Allow reading default templates for all authenticated users
...
INSERT INTO public.templates (user_id, name, description, html_content, is_default) VALUES
(
  '00000000-0000-0000-0000-000000000000', -- System user ID for default templates
  'Professional Welcome Email',
  'A modern, professional welcome email template with company branding',
  '<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
(
  ...
  'A contemporary newsletter template with multiple sections and modern design',
  '<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
